---
title: '项目部署到 Cloudflare Workers（Mac）'
category: '部署'
---
...
### 如果你的电脑是Windows 或者 你不想每次改动后都在本地执行部署命令`pnpm cf:deploy`，那么请看这篇（也适用于Mac）：[项目部署到 Cloudflare Workers（Windows)](#/shipany-two/deployment/deploy-to-cloudflare-windows)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899710607-5qd9e7.jpg)

2、确定是从cf分支起的项目；

> 注意1：你用cf分支创建的项目package.json中的"next": "15.5.5", 切记不能升级，因为一旦升级就打包失败，目前Cloudflare Workers暂不支持 Next.js 16；

> 注意2：Mac走的是本地部署推送到Cloudflare，所以不要去Cloudflare Workers & Pages 去手动创建Application，咱们是通过终端执行往上部署

## 项目部署

### 设置线上环境变量

在项目根目录通过下面的命令创建 `.env.production` 文件。
...
复制下面内容到`.env.production` 文件中，然后修改 `.env.production` 文件中的环境变量值，改成你的线上环境配置。

```
# app
NEXT_PUBLIC_APP_URL = "https://your-domain.com" // 这里需要修改
NEXT_PUBLIC_APP_NAME = "Your App Name" // 这里需要修改
...
# database
DATABASE_URL = "postgresql://user:password@domain:port/database" // 这里需要修改
DATABASE_PROVIDER = "postgresql"
DB_SINGLETON_ENABLED = "false"

# auth secret
# openssl rand -base64 32
AUTH_SECRET = "your-secret-key" // 这里需要修改

```

### 设置部署文件

在项目根目录通过下面的命令创建`wrangler.toml` 文件。
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899817319-fkt1qk.jpg)

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899838279-t5koim.jpg)

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899847024-6hlufw.jpg)

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899854473-gxc6ju.jpg)
...
[如何购买便宜的域名](#/shipany-two/others/buy-cheap-domain)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899939690-fj9w0g.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899945772-hkmhsj.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899952107-ensica.jpg)

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899960587-plu5se.jpg)

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765899971969-ue0j26.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900174349-cxxjy3.jpg)

在创建 Hyperdrive 配置页面，选择 Connect to public database，然后填入数据库配置信息。

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900195154-un12c3.jpg)

Configuration name ：是给你自己看的配置名称，填什么无所谓。

Connection String ：要填写项目线上环境的数据库连接地址。例如：

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900214184-teus0a.jpg)

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900223718-x8y0d7.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900231016-y4ilsp.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900242404-hfhvwv.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900249555-qx05ac.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900262963-cuf5sa.jpg)
...
![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900285067-p5sln9.jpg)

点击后（漫长等待部署（按钮置灰 不是卡死）），Cloudflare 会自动将 Hyperdrive 绑定到你的应用，你的代码就可以通过 env.HYPERDRIVE.connectionString 来使用优化后的数据库连接了。

![](https://img-template-nano-banana.16781678.xyz/uploads/2025-12-16/1765900292360-r0bklx.jpg)
