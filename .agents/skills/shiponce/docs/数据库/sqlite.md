...
你可以使用 [Turso](https://shipany.ai/zh/docs/database/turso) 等兼容 SQLite 的数据库服务。
...
Previous Page](https://shipany.ai/zh/docs/database/turso)[MySQL

Next Page](https://shipany.ai/zh/docs/database/mysql)
