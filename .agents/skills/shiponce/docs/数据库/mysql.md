...
你可以使用 [Supabase](https://shipany.ai/zh/docs/database/supabase) / [Turso](https://shipany.ai/zh/docs/database/turso) 等云数据库服务。
...
Previous Page](https://shipany.ai/zh/docs/database/sqlite)[Cloudflare D1

Next Page](https://shipany.ai/zh/docs/database/d1)
