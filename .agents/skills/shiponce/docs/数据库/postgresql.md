...
你可以使用 [Supabase](https://shipany.ai/zh/docs/database/supabase)、[Neon](https://shipany.ai/zh/docs/database/neon) 等兼容 PostgreSQL 的数据库服务。
...
Previous Page](https://shipany.ai/zh/docs/database/neon)[Turso

Next Page](https://shipany.ai/zh/docs/database/turso)
