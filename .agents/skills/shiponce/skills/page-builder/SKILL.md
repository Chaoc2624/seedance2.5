...
This skill creates **new pages** using the **dynamic page builder** approach: a page is rendered from locale JSON files and activated by registering the path in the locale message system.

This skill is intentionally **much simpler** than `quick-start`: it only creates new dynamic pages.

## v1 edit scope (hard limit)

For v1, you may **only**:

- Add **new** multi-language dynamic page JSON files under the locale messages directory
- Register new page paths in the locale configuration
...
2. Generate locale files and register the page path:
