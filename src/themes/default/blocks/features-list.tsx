        ...
        <div className="flex flex-wrap items-center gap-8 pb-12 md:gap-24">
          ...
          <div className="w-full min-w-0 flex-1">
            <ScrollAnimation delay={0.1}>
              <h2 className="text-4xl font-semibold text-balance break-words text-foreground">
                {section.title}
              </h2>
            </ScrollAnimation>
            <ScrollAnimation delay={0.2}>
              <p className="text-md my-6 text-balance break-words text-muted-foreground">
                {section.description}
              </p>
            </ScrollAnimation>
                    ...
                    >
                      <Link
                        ...
                        className={cn(
                          ...
                          'h-9 px-4 py-2',
                          'border border-transparent bg-background shadow-sm ring-1 shadow-black/15 ring-foreground/10 duration-200 hover:bg-muted/50 dark:ring-foreground/15 dark:hover:bg-muted/50'
                        )}
                      >
                        {button.icon && (
