  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-md mx-auto mb-4 max-w-full text-muted-foreground md:max-w-5xl">
          {section.description}
        </p>
      </motion.div>
        ...
        {filteredItems.length > 0 ? (
          filteredItems.map((item, index) => {
            ...
            const cardContent = (
              ...
              >
                <Card className="overflow-hidden p-0 shadow-sm shadow-black/5 transition-all hover:-translate-y-1 hover:shadow-md dark:hover:shadow-primary/10">
                      ...
                      {hasButton && (
                        <div className="mt-4">
                          <Button
                            ...
                            size={(item as any).button.size || 'default'}
                            className="w-full border-0 bg-primary px-3 py-1.5 text-sm font-medium text-white hover:bg-primary/90"
                          >
                            <Link
