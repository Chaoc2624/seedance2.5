  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-md mx-auto mb-4 line-clamp-3 max-w-full text-muted-foreground md:max-w-5xl">
          {section.description}
        </p>
            ...
            (group: { name: string; title: string }, index: number) => {
              ...
              return (
                ...
                >
                  {isSelected ? (
                    <>
                      <span className="absolute inset-0 rounded-lg bg-primary p-[2px]">
                        <span className="block h-full w-full rounded-[calc(0.5rem-2px)] bg-background" />
                      </span>
                ...
                {(item as any).button && (
                  ...
                  >
                    <Button
                      ...
                      className="h-8 w-full border-0 bg-primary px-1 py-1.5 text-sm font-medium text-primary-foreground hover:bg-primary/90"
                    >
                      <Link
        ...
        {selectedIndex !== null &&
          ...
          filteredItems.length > 0 && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#050604] p-4 md:p-8"
              ...
              >
                ...
                >
                  <LazyImage
                    ...
                    className="h-auto max-h-[calc(100dvh-4rem)] w-auto max-w-[calc(100vw-4rem)] object-contain shadow-[0_34px_140px_rgba(0,0,0,0.5)]"
                  />
                </div>
              </motion.div>
            </motion.div>
